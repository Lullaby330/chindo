...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "5847911776:AAHHZeEnPfbZmug4qkAU-fPLtmtk6AaLyJU")
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS",  "5319711962 5223873155").split()):
        ADMINS.append(int(x))
except ValueError:
